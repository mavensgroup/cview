...
pub fn get_cromer_mann_coeffs(element: &str) -> [f64; 9] {
    match element {
        ...
        _ => [
            2.3100, 20.8439, 1.0200, 10.2075, 1.5886, 0.5687, 0.8650, 51.6512, 0.2156,
        ],
    }
}

/// Returns the ionic radius (Å) for a given element symbol
/// --- DATA: Shannon Ionic Radii (most common oxidation, CN = 6) ---
/// --- Noble gases / undefined ions return 0.0 ---
pub fn get_atom_ionic_radius(element: &str) -> f64 {
    match element {
        ...
        // --- Superheavy (estimated / undefined) ---
...
///  --- DATA: Alvarez (2013) Van der Waals Radii ---
...
// Returns (covalent_radius_in_angstroms, (r, g, b))
// Radii: covalent radii (Å)
// Colors: Material Design (normalized RGB)
pub fn get_atom_properties(element: &str) -> (f64, (f64, f64, f64)) {
    match element {
        // ---------------- Period 1 ----------------
        "H" => (0.37, (0.76, 0.88, 0.62)),  // Green 200
        "He" => (0.32, (0.70, 0.89, 0.96)), // Cyan 200

        // ---------------- Period 2 ----------------
        "Li" => (1.34, (0.94, 0.33, 0.31)), // Red 400
        "Be" => (0.90, (1.00, 0.70, 0.35)), // Orange 300
        "B" => (0.82, (0.30, 0.69, 0.60)),  // Teal 400
        "C" => (0.77, (0.56, 0.76, 0.29)),  // Green 500
        "N" => (0.75, (0.41, 0.73, 0.39)),  // Green 400
        "O" => (0.73, (0.30, 0.69, 0.31)),  // Green 600
        "F" => (0.71, (0.51, 0.78, 0.33)),  // Lime 500
        "Ne" => (0.69, (0.38, 0.80, 0.85)), // Cyan 400

        // ---------------- Period 3 ----------------
        "Na" => (1.54, (0.92, 0.26, 0.21)), // Red 500
        "Mg" => (1.30, (1.00, 0.60, 0.20)), // Orange 400
        "Al" => (1.18, (0.33, 0.59, 0.82)), // Blue 400
        "Si" => (1.11, (0.30, 0.69, 0.60)), // Teal 500
        "P" => (1.06, (0.56, 0.76, 0.29)),  // Green 600
        "S" => (1.02, (0.69, 0.82, 0.24)),  // Lime 600
        "Cl" => (0.99, (0.51, 0.78, 0.33)), // Lime 500
        "Ar" => (0.97, (0.18, 0.75, 0.83)), // Cyan 500

        // ---------------- Period 4 ----------------
        "K" => (1.96, (0.85, 0.20, 0.19)),  // Red 700
        "Ca" => (1.74, (0.96, 0.55, 0.19)), // Orange 600
        "Sc" => (1.44, (0.47, 0.53, 0.60)), // Blue Grey 500
        "Ti" => (1.36, (0.55, 0.61, 0.67)), // Blue Grey 400
        "V" => (1.25, (0.38, 0.45, 0.53)),  // Blue Grey 600
        "Cr" => (1.27, (0.33, 0.39, 0.45)), // Blue Grey 700
        "Mn" => (1.39, (0.26, 0.32, 0.36)), // Blue Grey 800
        "Fe" => (1.25, (0.21, 0.27, 0.31)), // Blue Grey 900
        "Co" => (1.26, (0.38, 0.45, 0.53)),
        "Ni" => (1.21, (0.47, 0.53, 0.60)),
        "Cu" => (1.38, (0.55, 0.61, 0.67)),
        "Zn" => (1.31, (0.69, 0.75, 0.78)),
        "Ga" => (1.26, (0.33, 0.59, 0.82)),
        "Ge" => (1.22, (0.30, 0.69, 0.60)),
        "As" => (1.19, (0.30, 0.69, 0.60)),
        "Se" => (1.16, (0.56, 0.76, 0.29)),
        "Br" => (1.14, (0.69, 0.82, 0.24)),
        "Kr" => (1.10, (0.18, 0.75, 0.83)),

        // ---------------- Period 5 ----------------
        "Rb" => (2.11, (0.78, 0.17, 0.16)), // Red 800
        "Sr" => (1.92, (0.94, 0.50, 0.20)),
        "Y" => (1.62, (0.47, 0.53, 0.60)),
        "Zr" => (1.48, (0.55, 0.61, 0.67)),
        "Nb" => (1.37, (0.38, 0.45, 0.53)),
        "Mo" => (1.45, (0.33, 0.39, 0.45)),
        "Tc" => (1.56, (0.26, 0.32, 0.36)),
        "Ru" => (1.26, (0.21, 0.27, 0.31)),
        "Rh" => (1.35, (0.38, 0.45, 0.53)),
        "Pd" => (1.31, (0.47, 0.53, 0.60)),
        "Ag" => (1.53, (0.69, 0.75, 0.78)),
        "Cd" => (1.48, (0.33, 0.59, 0.82)),
        "In" => (1.44, (0.33, 0.59, 0.82)),
        "Sn" => (1.41, (0.30, 0.69, 0.60)),
        "Sb" => (1.38, (0.30, 0.69, 0.60)),
        "Te" => (1.35, (0.56, 0.76, 0.29)),
        "I" => (1.33, (0.69, 0.82, 0.24)),
        "Xe" => (1.30, (0.18, 0.75, 0.83)),

        // ---------------- Period 6 ----------------
        "Cs" => (2.25, (0.72, 0.11, 0.11)), // Red 900
        "Ba" => (1.98, (0.90, 0.49, 0.13)),

        // Lanthanides → Deep Purple
        "La" => (1.69, (0.58, 0.46, 0.80)),
        "Ce" => (1.63, (0.49, 0.34, 0.76)),
        "Pr" => (1.76, (0.40, 0.28, 0.71)),
        "Nd" => (1.74, (0.31, 0.23, 0.64)),
        "Pm" => (1.73, (0.26, 0.20, 0.59)),
        "Sm" => (1.72, (0.21, 0.18, 0.53)),
        "Eu" => (1.68, (0.18, 0.16, 0.49)),
        "Gd" => (1.69, (0.16, 0.14, 0.45)),
        "Tb" => (1.68, (0.14, 0.12, 0.41)),
        "Dy" => (1.67, (0.12, 0.10, 0.37)),
        "Ho" => (1.66, (0.10, 0.09, 0.34)),
        "Er" => (1.65, (0.09, 0.08, 0.31)),
        "Tm" => (1.64, (0.08, 0.07, 0.28)),
        "Yb" => (1.63, (0.07, 0.06, 0.25)),
        "Lu" => (1.62, (0.06, 0.05, 0.22)),

        // ---------------- Period 7 ----------------
        "Fr" => (2.60, (0.62, 0.08, 0.08)),
        "Ra" => (2.21, (0.85, 0.40, 0.11)),

        // Actinides → Indigo
        "Ac" => (1.86, (0.49, 0.54, 0.80)),
        "Th" => (1.75, (0.39, 0.44, 0.75)),
        "Pa" => (1.69, (0.30, 0.34, 0.71)),
        "U" => (1.70, (0.25, 0.30, 0.67)),
        "Np" => (1.71, (0.21, 0.26, 0.63)),
        "Pu" => (1.72, (0.18, 0.23, 0.59)),
        "Am" => (1.73, (0.16, 0.20, 0.55)),
        "Cm" => (1.74, (0.14, 0.18, 0.51)),
        "Bk" => (1.70, (0.12, 0.16, 0.47)),
        "Cf" => (1.69, (0.10, 0.14, 0.43)),
        "Es" => (1.68, (0.09, 0.12, 0.39)),
        "Fm" => (1.67, (0.08, 0.11, 0.35)),
        "Md" => (1.66, (0.07, 0.10, 0.32)),
        "No" => (1.65, (0.06, 0.09, 0.29)),
        "Lr" => (1.64, (0.05, 0.08, 0.26)),

        // Superheavy (consistent fallback)
        "Rf" | "Db" | "Sg" | "Bh" | "Hs" | "Mt" | "Ds" | "Rg" | "Cn" | "Nh" | "Fl" | "Mc"
        | "Lv" | "Ts" | "Og" => (1.60, (0.38, 0.45, 0.53)),

        // ---------------- Unknown ----------------
        _ => (1.00, (1.00, 0.08, 0.58)), // Hot pink error
    }
}

/// Helper: Extracts just the radius from the existing properties.
pub fn get_atom_cov(element: &str) -> f64 {
    let (radius, _) = get_atom_properties(element);
    radius
}
